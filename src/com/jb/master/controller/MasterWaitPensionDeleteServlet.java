...
/**
 * Servlet implementation class MasterWaitPensionDeleteServlet
 */
@WebServlet("/master/waitDelete")
public class MasterWaitPensionDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MasterWaitPensionDeleteServlet() {
        super();
