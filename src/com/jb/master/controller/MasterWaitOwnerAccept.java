...
/**
 * Servlet implementation class MasterWaitOwnerAccept
 */
@WebServlet("/master/waitOwnerAccept")
public class MasterWaitOwnerAccept extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MasterWaitOwnerAccept() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//승인(추가)할 업주들 아이디 받아오기
		String accList = request.getParameter("accOwnerList");
