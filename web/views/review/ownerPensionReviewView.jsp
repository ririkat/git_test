...
<section id="review-container" class="container">
   <div class="col-sm-9">
   <center><p class="title" style="color: #6a60a9;">리뷰</p></center>
...
<!--       </tr> -->
   ...
   <input type="button" id="toList" class="btn btn-default pull-right" value="리뷰목록으로" onclick="toList()"/>
...
<!--       <input type="button" class="btn btn-default pull-right" value="신고" onclick="out()"/> -->
   <script>
      function toList(){
         location.href="<%=request.getContextPath() %>/review/ownerReviewList?pensionCode=<%=pCode%>";
      }
