    ...
    <tbody>
        <form action="<%=request.getContextPath() %>/board/boardFormEnd" method="post" encType="multipart/form-data">
            ...
            <tr>
                ...
                <th>내용 : </th>
                <td>
                	<textarea cols="10" placeholder="내용을 입력하세요. " name="content" class="form-control"></textarea>
                </td>
            </tr>
            <tr>
                <th>첨부파일 : </th>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="button" value="취소" class="btn btn-default pull-left"/>
                    <input type="button" value="글 목록으로 " class="btn btn-default pull-right" onclick="toList()";/>
                </td>
            </tr>
        </form>
    </tbody>
