...
<section id="enroll-container">
                  ...
                  <tbody>
                     <tr>
                        <th class="point" style="vertical-align: middle"><strong
                           ...
                           %>
                        <td><input type="text" name="oName" id="oName" value="<%=o.getoName()%>" required></td>
                     </tr>
                  <tr>
                     <th class="point"><strong class="point">*</strong>아이디</th>
                     <td><input type="hidden" value="<%=o.getoId()%>" name="oId" id="oId" readonly><%=o.getoId()%>
            ...
            <tr>
                             ...
                             <td>
                              <input value="<%=obirthYY %>" check-join-date input-number type="number" name="oBirthYY" id="oBirthYY" min="1900" max="2005" maxlength="4" >년                            
                              <input value="<%=obirthMM %>" check-join-date input-number type="number" name="oBirthMM" id="oBirthMM" min="01" max="12" maxlength="2" >월                            
                              <input value="<%=obirthDD %>" check-join-date input-number type="number" name="oBirthDD" id="oBirthDD" min="01" max="31" maxlength="2"  >일                           
                     ...
                     <tr>
                      ...
                      <% if(o.getoGender().trim().equals("M")){%>
                       <input type="radio" name="oGender" id="oGender0" value="M" checked>
                       <label for="oGender0">남</label>
                      
                       <input type="radio" name="oGender" id="oGender1" value="F">
                       <label for="oGender1">여</label>
                       ...
                       <input type="radio" name="oGender" id="oGender1" value="F" checked>
                       <label for="oGender1">여</label>
                       <%} %>
                   </td>
                     </tr>
             ...
             <tr>
                 ...
                 <td>
                   <input type="tel" placeholder="(-없이)01012345678" name="oPhone" id="oPhone" 
                   onkeyup="onlynumber();" value='<%=o.getoPhone()%>'>
